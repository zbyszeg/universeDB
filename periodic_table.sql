...
--
-- Name: elements c_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements c_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT c_symbol UNIQUE (symbol);
